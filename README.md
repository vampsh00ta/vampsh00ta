...
## Меня зовут Влад. Я учусь на третьем курсе МАИ . Я  бэкэнд-разработчик со знаниям Python, Golang, Linux, Git, PostgresQL, gRPC и REST API. Я увлечен разработкой  эффективных и масштабируемых серверных систем
